export const normalizedComments1 = [
    {
        "id": "qwerqwer",
...
export const normalizedComments = [
  {
    img: require("../assets/image/chat-message-1.png"),
    logo: require("../assets/image/buffalo-wild-wings-logo-1.png"),
    title: "Раклет",
...
export const restInfo2 = [
  {
    img: require("../assets/image/markets-block.png"),
    logo: require("../assets/image/buffalo-wild-wings-logo-1.png"),
    title: "Раклет",
    note: "швейцарская, сырная",
    address: "Павильон 23",
