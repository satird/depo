...
import SlideNewsCard from './modulComponents/SlideNewsCard';
import stylesH from './modulComponents/styles/MainSliderHead';


export default class MainSliderNews extends Component {
	render() {
		return (
		  <View style={styles.mainSchoolSlider}>
				<View style={stylesH.heading}>
		      <Text style={stylesH.headingLeft}>Новости</Text>
