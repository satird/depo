...
const CardRest = () => (
datas.map((data, i) => (
	<TouchableOpacity style={[styles.cardContainerLink, {backgroundColor:data.bgcolor}]} activeOpacity={0.8}  key={(data,i) => index}>
      ...
      <View style={styles.cardContentContainer}>
        <View style={styles.cardLogo}>
          <Image source={data.logo} style={styles.cardLogoImage} />
        </View>
